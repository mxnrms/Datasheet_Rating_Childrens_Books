...
abstract: "This datasheet describes Alex Cookson's data on Children's Book Ratings. This dataset is comprised of textual documents with the ratings of children's books and it is also made publicly available in GitHub."
format:
  pdf:
...
The dataset of interest is Alex Cookson's data on the ratings of children's books [@alexcookson_childrensbookratings]. The dataset is publicly available on GitHub, alongside other datasets that Cookson has used for personal projects, which are usually associated with blog posts on his website. The Children's Book Ratings dataset is comprised of a README file and 3 textual documents, which display the variables and data relating to the ratings for approximately 9000 children's books. For the datasheet of this dataset, I follow the recommendations of Gebru et al. [@gebru2021datasheets].
...
-   **Does the dataset contain all possible instances or is it a sample (not necessarily random) of instances from a larger set? If the dataset is a sample, then what is the larger set? Is the sample representative of the larger set (for example, geographic coverage)? If so, please describe how this representativeness was validated/verified. If it is not representative of the larger set, please describe why not (for example, to cover a more diverse range of instances, because instances were withheld or unavailable).**
    -   The dataset specifies that it contains approximately 9000 children's books that have been rated from one to five stars. It is not known whether the dataset contains all the possible instances of children's books that have received a one to five star rating.
...
-   **Has an analysis of the potential impact of the dataset and its use on data subjects (for example, a data protection impact analysis) been conducted? If so, please provide a description of this analysis, including the outcomes, as well as a link or other access point to any supporting documentation.**
    -   Some forms of statistical bias were noted, such as self-selection bias, when giving a book a rating [@alexcookson_blogpost].
-   **Any other comments?**
    -   No.
...
-   **How can the owner/curator/manager of the dataset be contacted (for example, email address)?**
    -   Alex can be contacted directly through his Twitter[^1] or through his website[^2].
...
[^1]: https://twitter.com/alexcookson

[^2]: https://www.alexcookson.com/
